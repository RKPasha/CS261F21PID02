...
################################################################################
# Form generated from reading UI file 'scrapWindowbvkyOg.ui'
##
...
class Ui_ScrapWindow(object):
    def setupUi(self, ScrapWindow):
        ...
        self.label_2.setStyleSheet(u"QLabel{\n"
                                   ...
                                   "border-radius:12px;\n"
                                   "}")
        self.StartBtn = QLabel(self.frame)
        self.StartBtn.setObjectName(u"StartBtn")
        self.StartBtn.setGeometry(QRect(230, 200, 371, 221))
        self.StartBtn.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
        self.StartBtn.setStyleSheet(u"image: url(start1.png);"
                                    "QLabel::hover"
                                    "{"
                                    "margin : 100px;"
                                    "}")
        self.ExitBtn = QLabel(self.frame)
        self.ExitBtn.setObjectName(u"ExitBtn")
        # self.label.mousePressEvent = self.click
        self.ExitBtn.setGeometry(QRect(370, 380, 91, 81))
        self.ExitBtn.setStyleSheet(
            u"image: url(exit-button-orb-1098096-removebg-preview.png);")
    ...
    def retranslateUi(self, ScrapWindow):
        ScrapWindow.setWindowTitle(QCoreApplication.translate(
            "ScrapWindow", u"MainWindow", None))
        self.label.setText("")
        self.label_2.setText(QCoreApplication.translate(
            "ScrapWindow", u"     What Mobile gathers data from websites to reveal the latest smartphones.The scrapped data contains feature,price tags, ratings, and reviews. ", None))
